  ...
  return (
    <header
      className={cn(
        ...
        scrolled || mobileOpen ? "shadow-lg" : "bg-transparent",
        mobileOpen ? "bg-[var(--mobile-nav-bg)]" : scrolled ? "glass-strong" : "bg-transparent"
      )}
    >
      <nav className="container-max flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          <button
            ...
            className="rounded-lg p-2 text-foreground cursor-pointer"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="mobile-nav-panel overflow-hidden md:hidden"
          >
